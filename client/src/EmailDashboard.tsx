...
const EmailDashboard = () => {
  ...
  const handlePreview = async () => {
    ...
    const samplePreview = `Dear John Doe,
...
Your Company Team`;
  ...
  const handleSendEmails = async () => {
    ...
    setTimeout(() => {
      setStatus([
        "✅ Successfully sent to john@example.com",
        "✅ Successfully sent to jane@example.com", 
        "❌ Failed to send to invalid@email",
        "✅ Successfully sent to admin@company.com",
        "✅ Total: 3/4 emails sent successfully"
      ]);
      setLoading(false);
    }, 3000);
  };
                ...
                {preview ? (
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <div className="border-b border-gray-200 pb-3 mb-3">
                      <p className="text-sm text-gray-600">Subject: Your personalized message</p>
                      <p className="text-sm text-gray-600">To: john@example.com</p>
                    </div>
